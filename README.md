...
3. Use `Shift + Enter` to run each cell
4. Or use "Run All" from the Cell menu to execute all cells at once
...
4. **Select your Python interpreter** (the one with dependencies installed)
5. **Run cells** by clicking the play button or using `Shift + Enter`

## Reproduction Steps

Follow these steps to reproduce the entire analysis:
...
- **Solution**: Verify `dataset/Telco-Customer-Churn.csv` exists in the correct location

**Issue**: Kernel errors in Jupyter
- **Solution**: Restart the kernel and run all cells again

**Issue**: Memory errors with TensorFlow
- **Solution**: Reduce batch size in the deep learning model or use a machine with more RAM

## License

This project is for educational purposes as part of ITMD 524 coursework.
